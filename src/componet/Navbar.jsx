...
const Navbar = () => {
  ...
  return (
    <div>
      <main>
        <div className='text-white flex  justify-between items-center container max-w-[1240] capitalize h-25 mx-auto px-5'>
          <h1 className='w-full text-3xl font-bold text-[lightgreen] uppercase h-25 pt-4'> react</h1>
